...
const Contacts = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-background-secondary/30 relative overflow-hidden">
      ...
      <div className="relative z-10 py-6 md:py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-9xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            {contactCards.map((card, index) => (
              <motion.div
                ...
                className="group relative bg-background rounded-3xl shadow-lg hover:shadow-2xl p-6 border border-border/50 hover:border-primary/30 transition-all duration-500 overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  <div className={`inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br ${card.color} mb-4 group-hover:scale-110 transition-transform duration-500`}>
                    <div className={`${card.iconColor} text-2xl`}>{card.icon}</div>
                  </div>
                  <h3 className="font-bold text-foreground text-xl mb-3 group-hover:text-secondary transition-colors duration-300">
                    {card.title}
                  </h3>
          ...
          <div className="grid lg:grid-cols-3 gap-4 mb-6 items-stretch">
            ...
            >
              <div className="bg-background rounded-3xl shadow-2xl p-6 border border-border/50 backdrop-blur-sm w-full flex flex-col">
                ...
                <form onSubmit={handleSubmit} className="flex-1 flex flex-col">
                  <div className="space-y-4 flex-1">
                    ...
                    <div className="group">
                      <label
                        htmlFor="name"
                        className="block text-foreground font-semibold mb-2 group-hover:text-secondary transition-colors"
                      >
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-12 pr-5 py-3 border-2 border-border rounded-xl focus:ring-2 focus:ring-primary/50 focus:border-primary bg-background transition-all duration-300 text-foreground placeholder-foreground-tertiary hover:border-primary/50"
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        rows={5}
                        className="w-full pl-12 pr-5 py-3 border-2 border-border rounded-xl focus:ring-2 focus:ring-primary/50 focus:border-primary bg-background transition-all duration-300 resize-none text-foreground placeholder-foreground-tertiary hover:border-primary/50"
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full mt-4 group relative bg-gradient-to-r from-primary to-tertiary hover:from-primary-light hover:to-tertiary-light text-white px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-2xl disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer overflow-hidden"
                  >
            ...
            >
              ...
              <div className="bg-background rounded-3xl shadow-2xl p-6 border border-border/50 backdrop-blur-sm flex-1 flex flex-col">
                ...
                <div className="space-y-3">
                  {contactInfo.map((item, index) => (
                    <motion.div
                      ...
                      whileHover={{ x: 5 }}
                      className="group flex items-start p-4 rounded-2xl hover:bg-background-secondary transition-all duration-300 cursor-pointer border border-transparent hover:border-primary/20"
                    >
                      <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center mr-4 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300">
                        <div className="text-secondary text-lg">{item.icon}</div>
                      </div>
                      <div className="flex-1 min-w-0">
                        <h3 className="font-bold text-foreground text-base mb-1">
                          {item.title}
                        </h3>
                        <p className="text-secondary font-semibold text-sm mb-1 break-words">
                          {item.description}
                        </p>
                        {item.details && (
              ...
              {/* Social Media Card */}
              <div className="bg-gradient-to-br from-background to-background-secondary rounded-3xl shadow-2xl p-6 border border-border/50 backdrop-blur-sm flex-1 flex flex-col">
          ...
          >
            <div className="p-4 md:p-6 border-b border-border bg-gradient-to-r from-background to-background-secondary">
            ...
            <div className="relative h-[450px] md:h-[500px]">
              ...
              >
                ...
                <div className="space-y-2 text-xs text-foreground-tertiary">
                  ...
                  <div className="flex items-center gap-2">
                    <i className="fa-solid fa-calendar-check text-secondary"></i>
